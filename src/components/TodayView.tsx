    ...
    <div id="today-view-root" className="flex-1 flex flex-col bg-[#070707] relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-[180px]">
        ...
        <div className="px-3 pt-4 pb-2 select-none flex flex-col">
          <span className={`text-[10px] text-stone-400 leading-none mb-1.5 font-semibold ${isAr ? 'font-sans tracking-normal' : 'font-mono uppercase tracking-widest'}`}>
          ...
          <div className={`flex items-center gap-2 mt-2 bg-[#D4AF37]/10 border border-[#D4AF37]/25 text-[#D4AF37] px-3 py-1.5 rounded-xl text-[10px] w-fit select-none ${isAr ? 'font-sans tracking-normal' : 'font-mono uppercase tracking-widest'}`}>
            ...
            <div className="col-span-5 flex flex-col items-center justify-center p-1 ltr:border-l rtl:border-r border-stone-900/40">
              ...
              <div className="relative w-20 h-20 flex items-center justify-center mb-1">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center leading-none">
                  ...
                  <span className={`text-[7.5px] text-stone-500 mt-0.5 ${isAr ? 'font-sans tracking-normal' : 'font-mono uppercase tracking-wider'}`}>
                    {isAr ? 'إنجاز' : 'Goal'}
                  </span>
                </div>
              </div>
      ...
      <div className="px-3 pt-2 space-y-2">
        ...
        <h3 className={`text-[11px] text-stone-500 font-bold px-1 select-none ${isAr ? 'font-sans tracking-normal' : 'font-mono uppercase tracking-widest'}`}>
