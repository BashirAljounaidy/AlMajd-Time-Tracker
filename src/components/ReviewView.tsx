  ...
  return (
    <div id="review-screen-root" className="flex-1 flex flex-col bg-[#070707] overflow-y-auto no-scrollbar p-5 pb-24 space-y-5">
      ...
      <div className="select-none flex flex-col">
        <span className="text-[9px] font-mono text-[#D4AF37]/80 uppercase tracking-widest leading-none mb-1">
      ...
      <div className="space-y-3">
        <h3 className="text-[11px] uppercase tracking-widest font-mono text-stone-500 font-bold px-1 flex items-center gap-1.5">
      ...
      <div className="space-y-3">
        <h3 className="text-[11px] uppercase tracking-widest font-mono text-stone-500 font-bold px-1">
